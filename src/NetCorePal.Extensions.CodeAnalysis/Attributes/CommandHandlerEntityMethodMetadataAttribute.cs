...
public sealed class CommandHandlerEntityMethodMetadataAttribute : MetadataAttribute
{
    ...
    public CommandHandlerEntityMethodMetadataAttribute(string handlerType, string commandType, string entityType,
