...
public class MongoDBNetCorePalMonitoringApi<TDbContext> : IMonitoringApi where TDbContext : DbContext, ICapDataStorage
{
    private readonly IServiceProvider _serviceProvider;
    private readonly ISerializer _serializer;

    public MongoDBNetCorePalMonitoringApi(IServiceProvider serviceProvider, ISerializer serializer)
    {
    ...
    private async Task<IDictionary<DateTime, int>> GetPublishedHourlyTimelineStats(string statusName)
    {
        ...
        // Load data to client first, then perform GroupBy operation in memory
