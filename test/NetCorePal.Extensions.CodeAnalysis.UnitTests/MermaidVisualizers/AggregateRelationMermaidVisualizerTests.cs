...
public class AggregateRelationMermaidVisualizerTests
{
    ...
    public void GenerateAllAggregateRelationDiagrams_ShouldReturnDiagramsForAggregates()
    {
        ...
        {
            new Node { Id = "Order", Name = "Order", FullName = "Test.Domain.Order", Type = NodeType.Entity, Properties = new Dictionary<string, object> { ["IsAggregateRoot"] = true } },
            new Node { Id = "DeliverRecord", Name = "DeliverRecord", FullName = "Test.Domain.DeliverRecord", Type = NodeType.Entity, Properties = new Dictionary<string, object> { ["IsAggregateRoot"] = true } },
        ...
        {
            new Relationship { FromNode = nodes[2], ToNode = nodes[0], Type = RelationshipType.CommandToEntityMethod },
